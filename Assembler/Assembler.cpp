...
*	@param[out] paramILen Длина параметра в байтах
*
...
*	@param[in] commI Числовое представление команды
*	@param[in] paramsI Массив параметров
*	@param[in] paramsILen Зазмер параметров в байтах
*
...
*
*	@param[in] name Имя метки, начиная с пробела
